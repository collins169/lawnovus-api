...
@ViewEntity({
  expression: `select 'books' as entity, bk.id, bk.title, bk."coverImageId" , bk."typeId", to_jsonb(bk.author) as author, ARRAY[]::varchar[]  as judges, ARRAY[]::varchar[] as lawyers, bk."publicationDate"  from "${process.env.STAGE}-books" bk
union
